...
import BookHouseAddressSuggest from "./BookHouseAddressSuggest";
import BookHouseAddressInput from "./BookHouseAddressInput";
import axios from "axios";

const APP_ID_HERE = "TyyA4lvXXjOPd3zEZVLc";
const APP_CODE_HERE = "0DHkAEBuxa_w2ZK5-Qdx9CoFs9pgeeSWtQ8GFOd8Ktg";
...
class AddressForm extends Component {
  ...
  onQuery(event) {
    ...
    axios
      .get("https://autocomplete.geocoder.api.here.com/6.2/suggest.json", {
        params: {
          apikey: "otRlF1hA5wEWblhnSq0nqS78nvWZ_oA_S0wTgS6A668",
          query: query,
          maxresults: 1
        }
      })
  ...
  onCheck(evt) {
    ...
    if (this.state.locationId.length > 0) {
      console.log("Inside onCheck if");
      params["locationId"] = this.state.locationId;
    } else {
      console.log("Inside onCheck else");
  ...
  render() {
    ...
    return (
      <div className="container">
        <BookHouseAddressSuggest
          query={this.state.query}
          onChange={this.onQuery}
        />
        <BookHouseAddressInput
